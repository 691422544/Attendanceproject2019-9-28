    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                ,{field: 'repairPeople', title: '员工编码'}
                ,{field: 'repairDate', title: '名称'}
                ,{field: 'cause', title: '早上上班时间'}
        ...
        table.on('tool(test)', function (obj) {
            ...
            if (obj.event === 'del') {
                layer.confirm('真的删除行么', function (index) {
                    $.ajax({
                        type: 'get',
                        url : 'repairCrad/deleterepairCrad',
                        data: {
                            id:obj.data.id
                        },
                        dataType: 'JSON',
                ...
                // open有四个参数, 标题, 路径, 宽,高
                xadmin.open('编辑', 'repairCrad/load?id='+obj.data.id, 500, 500);
            }
        });
    });
</script>
