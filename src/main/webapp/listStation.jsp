...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        ...
        <a class="layui-btn layui-btn-sm" lay-event="add" href="addStation.jsp">添加</a>
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                ,{field: 'post', title: '岗位名称'}
                ,{field: 'department', title: '所在部门'}
                ,{field: 'superior', title: '直接上级'}
                ,{field: 'jobCategory', title: '岗位类别'}
                ,{field: 'describe', title: '岗位职责描述'}
        ...
        table.on('tool(test)', function (obj) {
            ...
            if (obj.event === 'del') {
                ...
                // open有四个参数, 标题, 路径, 宽,高
                xadmin.open('编辑', 'station/load?id='+obj.data.id, 500, 500);
            }
        });
    });
</script>
